 ...
 { 
	...
	$scope.registerCustomer = function () { 
		...
		if($scope.custConfirm !== $scope.custPass) {
			...
			$scope.messages[0] = "Confirmation password does not match password.";
			return;
		}
		...
		if(this.findCustomer() == true)
		{
			$scope.messages[0] = "Duplicate - customer id in use.";
			return;
		} 
	 

		// if we are here edit errors occurred.
		// $scope.message will have the errors placed by routine editFields.
